...
export default function ReconciliationFlow() {
  ...
  const accountingInputRef = useRef<HTMLInputElement | null>(null);
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-ink-700/10 bg-white/80 p-5">
            <div className="flex flex-col gap-2 text-xs text-ink-500">
              ...
              <input
                ...
                type="file"
                accept=".csv,.CSV,text/csv,.tsv,text/plain"
                ref={bankInputRef}
                onClick={(event) => {
              ...
              {bankFileName ? (
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <span>Loaded: {bankFileName}</span>
                  <button
                    type="button"
                    className="secondary-button px-3 py-1 text-[10px]"
                    onClick={() => handleReplace(bankInputRef, setBankCsv, setBankFileName)}
                  >
                    Replace file
                  </button>
                </div>
          ...
          <div className="rounded-2xl border border-ink-700/10 bg-white/80 p-5">
            <div className="flex flex-col gap-2 text-xs text-ink-500">
              ...
              {accountingFileName ? (
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <span>Loaded: {accountingFileName}</span>
                  <button
                    type="button"
                    className="secondary-button px-3 py-1 text-[10px]"
                    onClick={() =>
                      handleReplace(accountingInputRef, setAccountingCsv, setAccountingFileName)
                    }
                  >
                    Replace file
                  </button>
